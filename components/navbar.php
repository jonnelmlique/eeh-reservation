...
<header class="header sticky-top fixed-top">
        ...
        <div class="container-fluid">
            <a class="navbar-brand bold-text" href="#">
                <button class="btn btn-secondary rounded-circle"
                    style="height: 16px; width: 8px !important; margin-bottom: 3px; margin-left: 4px; margin-right: 6px">
                </button>
                Enchanted Escapes Hotel
            </a>
